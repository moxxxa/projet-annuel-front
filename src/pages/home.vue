...
export default {
    data() {
        return {
            ...
            chooseGameDesc: "Use the filters to find the right game you need",
            startPredictText: "Start predicting",
            startPredictDesc: "Consult the best statistics than can feat for the selected game",
            droits: "Copyright © 2020 Soccer heist. All rights reserved.",
            apropos: "About us",
